...
namespace ModelCore.Helper
{
    public static class DataExtensionMethods
    {
        ...
        public static long DecryptLongKeyValue(this String keyValue)
        {
            return BitConverter.ToInt64(AppResource.Instance.DecryptSalted(Convert.FromBase64String(keyValue)), 0);
        }

        public static String EncryptKey(this long keyID)
        {
            return BitConverter.GetBytes(keyID).EncryptKey();
        }
