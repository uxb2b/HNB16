...
{
    public class DraftAdjustmentController : SampleController
    {
        public DraftAdjustmentController(IServiceProvider serviceProvider, ILoggerFactory loggerFactory) : base(serviceProvider, loggerFactory)
        {
        }
        ...
        public IActionResult ConfirmReview([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/DraftAdjustment/Module/ConfirmReview.cshtml");
        }
        ...
        public IActionResult ConfirmHandler([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/DraftAdjustment/Module/ConfirmComplete.cshtml");
        }
    }
}