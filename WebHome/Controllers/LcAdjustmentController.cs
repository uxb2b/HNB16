...
{
    public class LcAdjustmentController : SampleController
    {
        public LcAdjustmentController(IServiceProvider serviceProvider, ILoggerFactory loggerFactory) : base(serviceProvider, loggerFactory)
        {
        }
        ...
        public IActionResult ConfirmReview([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/LcAdjustment/Module/ConfirmReview.cshtml");
        }
        ...
        public IActionResult ConfirmHandler([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/LcAdjustment/Module/ConfirmComplete.cshtml");
        }
    }
}
