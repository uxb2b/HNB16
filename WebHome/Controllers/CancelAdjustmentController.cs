...
{
    public class CancelAdjustmentController : SampleController
    {
        public CancelAdjustmentController(IServiceProvider serviceProvider, ILoggerFactory loggerFactory) : base(serviceProvider, loggerFactory)
        {
        }
        ...
        public IActionResult ConfirmReview([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/CancelAdjustment/Module/ConfirmReview.cshtml");
        }
        ...
        public IActionResult ConfirmHandler([FromBody] ConfirmRequest request)
        {
            ...
            return View("~/Views/CancelAdjustment/Module/ConfirmComplete.cshtml");
        }
    }
}