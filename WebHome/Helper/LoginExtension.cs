...
namespace WebHome.Helper
{
    public static class LoginExtension
    {
        ...
        public static async Task SignOnAsync(this HttpContext context, UserProfile profile, bool remeberMe = true)
        {
            ...
            //從組態讀取登入逾時設定
            double loginExpireMinute = AppSettings.Default.LoginExpireMinutes;
            ...
            /// 
            //var roles = profile.SupervisorMan;
        }
        ...
        {
            UserProfile? profile = context.GetCacheValue("userProfile") as UserProfile;
        ...
        {
            return UserProfile.CreateInstance(pid);
        }
    }
